...
class LayerTow extends Resource
{
    public static function indexQuery(NovaRequest $request, $query)
    {
        return $query->where('current_stage', \App\Models\Order::STAGE_TOW);
    }
    public static function authorizedToViewAny(Request $request)
    {
        return optional($request->user())->hasPermissionTo('management Layer Tow');
    }
    /**
